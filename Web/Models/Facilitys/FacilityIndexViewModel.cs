...
{
    public class FacilityIndexViewModel : PageViewModel
    {
        public IEnumerable<FacilityViewModel> Facilitys { get; set; }
        public double AllInclusivePrice { get; set; }
        public double BreakfastPrice { get; set; }
        public int MaxCapacity { get; set; }
        public bool AvailableOnly { get; set; }
        public FacilityType[] Types { get; set; }
        ...
        public List<SelectListItem> GetTypesSelectList()
        {
            ...
            var enumValues = Enum.GetValues(typeof(FacilityType));
            foreach (var value in enumValues)
            {
                result.Add(
                    new SelectListItem
                    {
                        ...
                        Text = value.ToString(),
                        Selected = Types.Contains((FacilityType)value),
                    }) ;
            }
